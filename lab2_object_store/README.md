...
home directory (`$STEAM_DIRS` / `$STEAM_METADATA_DIR`, exported by your
...
`~/cloud-storage` automatically, so nothing in your code needs to know or
...
server's count will jump to roughly 3x what you recorded above, since
