...
Implement the nine TODO functions below (2.6, 2.7 and 2.8 are bonus, see
...
Keep the raw timing numbers you get: 2.3 in particular is needed again in
Lab 3C.
"""
import argparse
import glob
...
def task_2_2_flush():
    """
    Task 2.2: write loop, with and without an explicit flush.
    ...
    """
    raise NotImplementedError("task_2_2_flush: implement me")


def task_2_3_queue_depth_sweep():
    """
    Task 2.3: queue-depth sweep 1 to 256. KEEP THE RAW PER-OP TIMINGS.
    ...
    Lab 3C's TODO below is that turning point: the depth where more
    ...
    """
    raise NotImplementedError("task_2_3_queue_depth_sweep: implement me")


def task_2_4_buffered_cached_direct():
    """
    Task 2.4: buffered, cached, then O_DIRECT.
    ...
    """
    raise NotImplementedError("task_2_4_buffered_cached_direct: implement me")
...
def task_2_6_small_file_tax():
    """
    Task 2.6 (bonus): 100 MB as 1, 100, then 10,000 files.
